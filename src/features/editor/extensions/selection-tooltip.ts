    ...
    return [
        {
            ...
            create: () => {
                ...
                dom.className = "bg-popover text-popover-foreground z-50 rounded-sm border border-input p-1 shadow-md flex flex-row items-center gap-1 text-sm";
                ...
                quickEditButtonShortcut.className = "text-sm opacity-50";
