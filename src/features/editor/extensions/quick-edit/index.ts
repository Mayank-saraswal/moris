...
const createQuickEditTooltipField = (state: EditorView["state"]): readonly Tooltip[] => {
    ...
    return [
        {
            ...
            create: () => {
                ...
                input.type = "text";
                input.placeholder = "Edit this code...";
                input.className = "bg-transparent outline-none border-none px-2 py-1 font-sans w-100";
                input.autofocus = true;

                const buttonContainer = document.createElement("div");
                buttonContainer.className = "flex justify-between items-center gap-2";
